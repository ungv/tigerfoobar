...
$t_portablefiles = "PORTABLE FILES";
...
//== Tips ==
$t_tip_1_title = "Respect standards!";
$t_tip_1_text = "Download <a href='http://www.webcodesniffer.net/' target='_blank' title='WebCodeSniffer'>WebCodeSniffer</a> and<br />clean up your code";
$t_tip_2_title = "Track bugs!";
$t_tip_2_text = "Download the module <a href='http://www.easyphp.org/modules.php' target='_blank' title='EasyPHP Module : Xdebug Manager'>Xdebug&nbsp;Manager</a>";
$t_tip_3_title = "Setup your environment!";
$t_tip_3_text = "Configure Apache/MySQL/PHP (see above) and download the module <a href='http://www.easyphp.org/modules.php' target='_blank' title='EasyPHP Module : Virutal Hosts Manager'>Virtual&nbsp;Hosts&nbsp;Manager</a>";
...
$t_changemysqldatadir_warning_conf = "If you experience any problem, open the folder 'EasyPHP-xxx/conf_files/', delete or rename 'my.ini', rename the most recent backup to 'my.ini' and restart EasyPHP.";
